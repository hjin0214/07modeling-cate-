	...
	<tr>
      ...
      <div>
         ...
         <c:forEach var="cate" items="${cglist}">
            <span <c:if test="${cate.cateNo eq search.searchCategory }">style="font-weight: bold;"</c:if>><a href="javascript:fncGetList2(1, ${cate.cateNo});">${cate.cateName}</a></span>
	...
	<tr class="ct_list_pop">
		...
		<td align="left">
			...
			구매완료
					...
					<a href="/product/updateTranCodeByProd?prodNo=10000&tranCode=2">배송하기</a>
